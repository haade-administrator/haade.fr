...
var documents = [{
    "id": 0,
    "url": "/en/blog/test-nuki-smart-lock-ultra-fob-door-sensor-the-ultimate-smart-lock",
    "title": "Nuki Smart Lock Ultra, Fob and Door Sensor test the ultimate smart lock",
    "description": "28/08/2026 - Full test of the Nuki Smart Lock Ultra smart lock with the Fob and Door Sensor, Home Assistant integration via Matter and MQTT, Airbnb and rental services, comparison with the Tedee Go",
    "tags": ""},{
    "id": 1,
    "url": "/en/blog/test-kincony-b8m-esp32-mosfet-8ch-controller-esphome-irrigation",
    "title": "Kincony B8M ESP32 8-channel MOSFET controller test for irrigation",
    "description": "20/07/2026 - Full test of the Kincony B8M ESP32-S3 8-channel MOSFET controller with ESPHome and Home Assistant integration for irrigation system control, comparison with Waveshare ESP32-S3-ETH-8DI-8RO",
    "tags": ""},{
    "id": 2,
    "url": "/en/blog/dahua-the-full-option-ptz-camera-in-frigate",
    "title": "Dahua SD1A404DB-GNY the full option PTZ camera in Frigate",
    "description": "13/07/2026 - Test and integration of the Dahua SD1A404DB-GNY 4MP WizSense PTZ camera in Frigate with autotracking and Home Assistant, full technical specifications and PTZ functions",
    "tags": ""},{
    "id": 3,
    "url": "/en/blog/test-smlight-smhub-nano-le-hub-domotique-independant",
    "title": "SMLIGHT SMHUB NANO Review: The fully independent Linux smart home hub",
    "description": "08/07/2026 - A look at SMLIGHT’s SMHUB NANO, a Linux-based micro-server capable of running Zigbee2MQTT, Node-RED, and Matterbridge locally, without a central server.",
    "tags": "SMLIGHT - Matter - Thread - Zigbee"},{
    "id": 4,
    "url": "/en/blog/openwrt-access-point-guest-client-and-adguardhome-at-the-appointment",
    "title": "OpenWrt tutorials, AP bridge mode, guest access, and network protection",
    "description": "06/05/2026 - An OpenWrt tutorial that covers access point, guest mode, and AdGuardHome settings in a functional way using the LUCI interface.",
    "tags": ""},{
    "id": 5,
    "url": "/en/blog/test-and-integration-camera-reolink-trackmix-poe-frigate-homeassistant",
    "title": "Reolink Trackmix PoE camera review - Customer service needs improvement 🤬",
    "description": "22/04/2026 - Testing and integrating the Reolink Trackmix PoE camera with Frigate and Home Assistant, and a rant against the brand's customer service 👎",
    "tags": ""},{
    "id": 6,
    "url": "/en/blog/easily-install-yolov9-with-google-coral-for-frigate-omv9-supervisor-and-secure-home-assistant",
    "title": "Easily install YoloV9 and make detection smart",
    "description": "06/04/2026 - Here's a mini-tutorial that will interest many: YOLO V9, king of object detection, installed in one click.",
    "tags": ""},{
    "id": 7,
    "url": "/en/blog/unlock-your-xiaomi-router-in-5-minutes-with-xmir-patcher-and-use-openwrt",
    "title": "Easily unlock your Xiaomi router in 5 minutes",
    "description": "26/03/2026 - In this article I'm going to show you how to unlock your Xiaomi router and install OpenWrt in a single command line",
    "tags": ""},{
    "id": 8,
    "url": "/en/blog/test-dongle-smlight-slzb-mr4u-multiradio-zigbee-and-thread-it-works-like-a-charms",
    "title": "Smlight SLZB-MR4U multiradio dongle test",
    "description": "06/03/2026 - Testing the SMLIGHT SLZB-MR4U Zigbee and Thread Multiradio Dongle: It Works",
    "tags": ""},{
    "id": 9,
    "url": "/en/blog/externalize-your-home-assistant-backups-with-rsync-on-nas-or-server",
    "title": "Easily outsource your Home Assistant backup",
    "description": "04/02/2026 - Thanks to Rsync, automatically and easily offload your Home Assistant backups.",
    "tags": ""},{
    "id": 10,
    "url": "/en/blog/tuto-lixee-box-with-zlinky-tic-the-french-box-to-measure-analyze-and-save",
    "title": "Lixee Box Energy Saver",
    "description": "23/01/2026 - Testing the Lixee-Box, a box 100% compatible with Zlinky, enter the world of home automation and control your home's energy",
    "tags": ""},{
    "id": 11,
