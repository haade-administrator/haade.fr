...
var documents = [{
    "id": 0,
    "url": "/fr/blog/test-nuki-smart-lock-ultra-fob-opener-serrure-connectee-ultime",
    "title": "Test Nuki Smart Lock Ultra, Fob et Door Sensor la serrure connectée ultime",
    "description": "28/08/2026 - Test complet de la serrure connectée Nuki Smart Lock Ultra avec le Fob et le Door Sensor, intégration Home Assistant via Matter et MQTT, services Airbnb et location saisonnière, comparatif avec la Tedee Go",
    "tags": ""},{
    "id": 1,
    "url": "/fr/blog/test-kincony-b8m-controleur-esp32-mosfet-8ch-esphome-irrigation",
    "title": "Test du Kincony B8M contrôleur ESP32 8 canaux MOSFET pour l'irrigation",
    "description": "20/07/2026 - Test complet du Kincony B8M contrôleur ESP32-S3 8 canaux MOSFET avec intégration ESPHome et Home Assistant pour piloter un système d'irrigation, comparatif avec le Waveshare ESP32-S3-ETH-8DI-8RO",
    "tags": ""},{
    "id": 2,
    "url": "/fr/blog/dahua-la-camera-ptz-full-option-dans-frigate",
    "title": "Dahua SD1A404DB-GNY la caméra PTZ full option dans Frigate",
    "description": "13/07/2026 - Test et intégration de la caméra PTZ Dahua SD1A404DB-GNY 4MP WizSense dans Frigate avec autotracking et Home Assistant, caractéristiques techniques complètes et fonctions PTZ",
    "tags": ""},{
    "id": 3,
    "url": "/fr/blog/test-smlight-smhub-nano-le-hub-domotique-independant",
    "title": "Test SMLIGHT SMHUB NANO : Le hub domotique Linux totalement indépendant",
    "description": "08/07/2026 - Découverte du SMHUB NANO de SMLIGHT, un micro-serveur sous Linux capable de faire tourner Zigbee2MQTT, Node-RED et Matterbridge en local sans serveur central.",
    "tags": "SMLIGHT - Matter - Thread - Zigbee"},{
    "id": 4,
    "url": "/fr/blog/openwrt-acces-point-guest-client-et-adguardhome-au-rendez-vous",
    "title": "Tutos Openwrt, mode bridge AP, accès invité et protection du réseau",
    "description": "06/05/2026 - Un tuto Openwrt qui reprend les paramétrages point d'accès, guest mode, et adguardhome de façons fonctionnelles en utilisant l'interface LUCI",
    "tags": ""},{
    "id": 5,
    "url": "/fr/blog/test-et-integration-camera-reolink-trackmix-poe-frigate-homeassistant",
    "title": "Test camera Reolink Trackmix Poe - Service client à revoir 🤬",
    "description": "22/04/2026 - test et intégration de la caméra Reolink Trackmix Poe dans frigate et home assistant et coup de gueule contre le service client de la marque 👎",
    "tags": ""},{
    "id": 6,
    "url": "/fr/blog/installe-facilement-yolov9-avec-google-coral-pour-frigate-superviseur-omv9-et-securise-home-assistant",
    "title": "Installe facilement YoloV9 et rend la détection intelligente",
    "description": "06/04/2026 - Voilà un mini-tutos qui va encore en intéresser plus d'un, yolo V9 roi de la détections d'objets installé en un clic",
    "tags": ""},{
    "id": 7,
    "url": "/fr/blog/debloque-ton-routeur-xiaomi-en-5-minute-avec-xmir-patcher-et-utilise-openwrt",
    "title": "Débloque facilement ton routeur Xiaomi en 5 minutes",
    "description": "26/03/2026 - Dans cet article je vais te montrer comment débloquer ton routeur Xiaomi et installer Openwrt en 1 seule ligne de commande",
    "tags": ""},{
    "id": 8,
    "url": "/fr/blog/test-dongle-smlight-slzb-mr4u-multiradio-zigbee-et-thread-ca-marche-du-feu-de-dieu",
    "title": "Test dongle multiradio Smlight SLZB-MR4U",
    "description": "06/03/2026 - Test du dongle Multiradio Zigbee et Thread de la marque SMLIGHT SLZB-MR4U ça marche",
    "tags": ""},{
    "id": 9,
    "url": "/fr/blog/externalise-tes-sauvegardes-home-assistant-avec-rsync-sur-on-nas-ou-serveur",
    "title": "Externalise Facilement ta sauvegarde Home-Assistant",
    "description": "04/02/2026 - Grâce à Rsync externalise automatiquement et facilement tes sauvegardes Home Assistant",
    "tags": ""},{
    "id": 10,
