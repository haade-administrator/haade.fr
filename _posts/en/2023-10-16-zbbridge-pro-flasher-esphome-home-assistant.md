...
![How the zigbee firmware switch works in esphome]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/zigbee-firmware-update-esphome-sonoff-zbbridge-pro.webp{{ cachebuster }}){: width="400" height="275"}
...
[installing latest Zigbee firmware](https://github.com/haade-administrator/zbbridge-pro)
