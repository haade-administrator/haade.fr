...
![logo risque électrique]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/pngegg-150x150-820.webp)
...
![schema branchement pitinfo, wemos et compteur électrique]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/branchement-820.webp)
...
![entité téléinfo homeassistant avec pitinfo et wemos]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/entite-teleinfo-homeassistant-820.webp)
