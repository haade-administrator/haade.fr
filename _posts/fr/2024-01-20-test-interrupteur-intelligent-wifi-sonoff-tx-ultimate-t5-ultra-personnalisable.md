...
description: "Test de l'interrupteur intelligent wifi Sonoff Tx ultimate son et lumière au rendez-vous ultra personnalisable grâce aux caches interchangeables."
...
**Il existe néanmoins un inconvénient** lors de l'utilisation de cette application, c'est le fait que tu utilises un cloud chinois pour contrôler les modules wifi de la gamme Sonoff.
...
[Achat de 1 à 3 touches avec ou sans coques](https://s.click.aliexpress.com/e/_DBWogFn){: target="_blank"}
