...
![Mise en place thermostat generic dans home assistant]({{ site.baseurl }}/assets/images/posts/69/mise-en-place-generic-thermostat-lovelace-home-assistant.webp{{ cachebuster }}){: width="800" height="472" class="lazyload pictaninpost"}{: target="_blank"}
