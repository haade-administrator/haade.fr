...
D’ailleurs la société Nabu Casa qui détient le programme Homeassistant à acquis en Mars 2021 [le programme esphome](https://www.home-assistant.io/blog/2021/03/18/nabu-casa-has-acquired-esphome/){: target="_blank"}
...
> Vous pouvez retrouver [l’installation en Anglais sur esphome.io](https://esphome.io/guides/getting_started_hassio.html){: target="_blank"}
...
![installation esphome dans homeassistant]({{ site.baseurl}}/assets/images/posts/{{ page.guid }}/esphome-install.webp{{ cachebuster }}){: width="820" height="421" class="lazyload pictaninpost"}
...
![ajout module esphome dans homeassistant]({{site.baseurl}}/assets/images/posts/{{ page.guid }}/esphome-ajout.webp{{ cachebuster }}){: width="820" height="466" class="lazyload pictaninpost"}
