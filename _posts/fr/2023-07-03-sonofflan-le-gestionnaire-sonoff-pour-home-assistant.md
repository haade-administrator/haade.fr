...
![remontée d'info ecran digital sonoff smart meter powr316d]({{ site.baseurl}}/assets/images/posts/{{ page.guid }}/sonoff-smart-power-meter-powr316d-display.webp{{ cachebuster }}){: width="250" height="400" class="lazyload pictaninpost"}
...
![inclusion ewelink app sonoff smart meter powr316d]({{ site.baseurl}}/assets/images/posts/{{ page.guid }}/integration-module-sonoff-app-ewelink.webp{{ cachebuster }}){: width="300" height="650" class="lazyload pictaninpost"}
...
![entité découvert dans home assistant sonoff smart meter powr316d]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/entité-powr316d.webp{{ cachebuster }}){: width="940" height="789" class="lazyload pictaninpost"}
