...
categories: [Domotique, Haade-lab, Mini-tutos, Home-Assistant]
...
![modification une icone par défaut d'un device dans home assistant]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/modification-icone-device_class-element-binaire-personnalisation.webp{{ cachebuster }}){: width="820" height="404" class="lazyload pictaninpost"} 
