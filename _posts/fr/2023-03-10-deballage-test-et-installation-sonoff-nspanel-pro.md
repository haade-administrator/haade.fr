...
![Intégration caméra RTSP dans NSPanel Pro]({{ site.baseurl }}/assets/images/posts/52/integration-camera-nspanelpro.webp{{ cachebuster }}){: width="470" height="471" class="lazyload pictaninpost"}{: target="_blank"}
...
### avec le module Ewelink 100% Cloud
...
![Installation Ewelink Nspanel Pro sur Homeassistant]({{ site.baseurl }}/assets/images/posts/52/nspanel-pro-ewelink-installation.webp{{ cachebuster }}){: width="940" height="521" class="lazyload pictaninpost"}{: target="_blank"}
...
### en flashant le module avec android 100% locale
...
### En utilisant le [dépôt Sonofflan](https://github.com/AlexxIT/SonoffLAN){: target="_blank"} ( local et/ou cloud )
...
![Installation Nspanel Pro Sonofflan sur Homeassistant]({{ site.baseurl }}/assets/images/posts/52/installation-nspanel-sonofflan-homeassistant.webp{{ cachebuster }}){: width="940" height="517" class="lazyload pictaninpost"}{: target="_blank"}
