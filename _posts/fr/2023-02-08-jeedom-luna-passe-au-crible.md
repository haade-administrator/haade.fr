...
![Étape d'installation de la Jeedom Luna]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/etape-installation-box-jeedom-luna.webp{{ cachebuster }}){: width="940" height="474" class="lazy"}
...
![Application Jeedom Luna]({{ site.baseurl }}/assets/images/posts/{{ page.guid }}/jeedom-luna-app.webp{{ cachebuster }}){: width="242" height="477" class="lazy"}
