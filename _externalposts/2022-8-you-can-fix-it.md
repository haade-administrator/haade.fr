...
the recording of it right here! 
 ...
 Introducing Repairs: You can fix it! 
 A completely new feature we hope you are going to love: Repairs! ������������� 
...
Network settings screen. Thanks, @zsarnett! 
 Lutron Cas��ta now supports the Lutron RA3 Sunnata Keypads. Thanks, @danaues! 
...
integration now fully utilizes Network Configuration,
...
services. 
 ...
 The Bluetooth integration must be enabled before
switchbot can be used. Bluetooth is automatically discovered in most cases,
but can be manually added from the integrations page
if it is not. 
...
all changes made here: Full changelog for Home Assistant Core 2022.8 
"
